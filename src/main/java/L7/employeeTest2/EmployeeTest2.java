...
public class EmployeeTest2 {
    public static void main(String[] args) {
        ...
        //Employee secondEmpl = new Employee(2, "SecondEmployee"); // Из-за protected нельзя создать
        ...
        //System.out.println("ID = " + firstEmpl.id); Из-за protected нельзя получить
        ...
        //System.out.println("ID = " + secondEmpl.id); Из-за protected нельзя получить
